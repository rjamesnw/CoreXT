...
declare namespace CoreXT {
    ...
    */
     ...
     */
    function FactoryBase<TBaseFactory extends IFactory>(baseFactoryType?: TBaseFactory): {
        new (): {
     ...
     */
    namespace Loader {
        interface ISystemLoadedHandler {
            (): void;
        }
        /**
         ...
         */
        function onSystemLoaded(handler: ISystemLoadedHandler): void;
