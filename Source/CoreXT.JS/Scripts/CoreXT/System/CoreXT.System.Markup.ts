...
namespace CoreXT.System {
    ...
    export namespace Markup {
        namespace(() => CoreXT.System.Markup);
        ...
        /** Used to parse HTML text.
          ...
          */
        export class HTMLReader extends FactoryBase(Object) {
            /**
                 * Create a new HTMLReader instance to parse the given HTML text.
                 * @param html The HTML text to parse.
                 */
            static 'new'(html: string): IHTMLReader { return null; }
        ...
        export namespace HTMLReader {
            export class $__type extends FactoryType(Object) {
                ...
                */
                ...
                private static [constructor](factory: typeof HTMLReader) {
                    factory.init = (o, isnew, html) => {
                        ...
                        o.nonDelimiters = (<any>o.html).split($__type.__splitRegEx, void 0, o.delimiters); // (get text parts [inverse of 'match()']; last argument is ignored on newer systems [see related polyfill in CoreXT.Browser])
                    };
                }
            }
        ...
        export interface IHTMLReader extends HTMLReader.$__type { }
