...
namespace CoreXT.System {
        ...
        export class $__type<TObj extends object, TFunc extends DelegateFunction> extends FactoryType(CoreObject) {
            ...
            private [constructor](): void {
                ...
                */
                ...
                $__type.prototype.invoke = <any>makeCases(0, 20, function () {
                ...
                $__type.prototype.call = <any>((Browser.type != Browser.BrowserTypes.IE) ?
                ...
                $__type.prototype.__apply = <any>makeCases(0, 20, apply, "$this.func", "context, ", "args"); // (keep reference to the non-bound version as a fallback for user defined contexts)
                $__type.prototype.apply = <any>((Browser.type != Browser.BrowserTypes.IE) ? $__type.prototype.__apply : makeCases(0, 20, apply, "$this.__boundFunc", "", "args")); // (note: bound functions are faster in IE)
            }
            ...
            */
            ...
            private static [constructor](factory: typeof Delegate) {
                factory.init = (o, isnew, object, func) => {
    ...
    export interface IDelegate<TObj extends object=object, TFunc extends DelegateFunction=DelegateFunction>
        extends Delegate.$__type<TObj, TFunc> { }
