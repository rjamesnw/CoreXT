...
interface IHostBridge {
    ...
    ///** Returns true if 'host' in the global scope represents the CoreXT Studio .NET environment (which implements CEF [the Chrome Embedded Framework]). */
    //??isCoreXTStudio(): boolean;
