...
namespace CoreXT.System.Platform {
     ...
     */
    export class Context extends FactoryBase(Object) {
        ...
        static init(o: IContext, isnew: boolean, context: Contexts = Contexts.Secure) {
    ...
    export namespace Context {
        export class $__type extends FactoryType(Object) {
            ...
            private static [constructor](factory: typeof Context) {
    ...
    export interface IContext extends Context.$__type { }
    ...
    /** 
      ...
      */
    export class UIApplication extends FactoryBase(Application) {
        static 'new'(title: string, appID: number): IUIApplication { return null; }

        static init(o: IUIApplication, isnew: boolean, title: string, description: string, appID: number) {
            this.super.init(o, isnew, title, description, appID);
        }
    }
    export namespace UIApplication {
        export class $__type extends FactoryType(Application) {
            ...
            private static [constructor](factory: typeof UIApplication) {
                //factory.init = (o, isnew) => {
                //};
            }
        }
