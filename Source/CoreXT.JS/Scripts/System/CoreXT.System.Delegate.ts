...
namespace CoreXT.System {
    ...
    /** 'InternalTypes' is a convention for temporarily storing class types (typically generic) for use with creating type factories. */
    namespace InternalTypes {
        export class Delegate<TObj extends object, TFunc extends DelegateFunction<object>> extends Object.$__type {
    ...
    export var Delegate = ClassFactory(System, Object,
        (base) => { return [InternalTypes.Delegate, InternalTypes.Delegate["DelegateFactory"]]; }
    );
    
    export interface IDelegate<TObj extends object, TFunc extends DelegateFunction<object>> extends InternalTypes.Delegate<TObj, TFunc> { }
