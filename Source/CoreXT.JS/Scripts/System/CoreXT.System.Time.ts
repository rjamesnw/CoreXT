...
namespace CoreXT.System {
     ...
     */
    export var TimeSpan = ClassFactory(System, Object,
        (base) => {
            class TimeSpan extends base {
                //  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .
                ...
                static now(): TimeSpan { return Date.now ? System.TimeSpan.new(Date.now()) : TimeSpan.fromDate(new Date()); }
    ...
    export interface ITimeSpan extends InstanceType<typeof TimeSpan.$__type> { }
