...
namespace CoreXT.System {
    ...
    */
    class $TimeSpan extends Factory(Object) {
        //  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .
        ...
        */
        ...
        static now(): $TimeSpan { return Date.now ? TimeSpan.new(Date.now()) : $TimeSpan.fromDate(new Date()); }
        ...
        static utcTimeToLocalTime(timeInMs: number): $TimeSpan {
            return TimeSpan.new((timeInMs || 0) - Time.__localTimeZoneOffset);
        }
        ...
        */
        toString(includeTime: boolean = true, includeMilliseconds: boolean = true, includeTimezone: boolean = true): string {
            if (!this.__localTS)
                this.__localTS = TimeSpan.new(this.toValue() - Time.__localTimeZoneOffset);
