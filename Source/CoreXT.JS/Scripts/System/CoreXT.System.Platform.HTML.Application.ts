...
namespace CoreXT.System.Platform.HTML.Application {
    registerNamespace("CoreXT", "System", "Platform", "HTML", "Application");
    ...
    export var ApplicationElement = ClassFactory(Application, HTML.HTMLElement,
        (base) => {
            class ApplicationElement extends base {
    ...
    export interface IApplicationElement extends InstanceType<typeof ApplicationElement.$__type> { }
