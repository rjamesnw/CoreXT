...
namespace CoreXT.System.Collections {
    ...
    */
    ...
    declare class IndexedObjectCollectionClass<TObject extends object> extends IndexedObjectCollection.$__type<TObject> { } // (temporary only to pull out the generic type)
    export interface IIndexedObjectCollection<TObject extends object=object> extends IndexedObjectCollectionClass<TObject> { }
