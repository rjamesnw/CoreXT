...
namespace CoreXT.System {
    ...
    registerNamespace("CoreXT", "System", "Markup");
        ...
        /** Used to parse HTML text.
          ...
          */
        export var HTMLReader = ClassFactory(Markup, Object,
            (base) => {
                class HTMLReader extends base {
                    // -------------------------------------------------------------------------------------------------------------------
        ...
        export interface IHTMLReader extends InstanceType<typeof HTMLReader.$__type> { }
