    ...
    export namespace System {
        ...
        export namespace Events {
            ...
            namespace InternalTypes {
                export class EventDispatcher<TOwner extends object, TCallback extends EventHandler> extends DependencyObject {
                   ...
                   */
                    ...
                    */
                    ...
                    protected static readonly 'EventDispatcherFactory' = function () {
                        ...
                        return class Factory extends FactoryBase(EventDispatcher, EventDispatcher['ObjectFactory']) implements IFactory {
            ...
            /** 
              ...
              */
            export var EventDispatcher = ClassFactory(Scripts, Object,
                (base) => {
                    return [InternalTypes.EventDispatcher, InternalTypes.EventDispatcher["EventDispatcherFactory"]];
                }
            );

            export interface IEventDispatcher<TOwner extends object, TCallback extends EventHandler> extends InternalTypes.EventDispatcher<TOwner, TCallback> { }
        }
