...
namespace CoreXT {
    export namespace System {
        ...
        export namespace Events {
            namespace(() => CoreXT.System.Events);
            ...
            /** 
              ...
              */
            export class EventDispatcher extends FactoryBase(Object) {
                ...
                static init<TOwner extends object, TCallback extends EventHandler>(o: EventDispatcher.$__type<TOwner, TCallback>, isnew: boolean, owner: TOwner, eventName: string,
            ...
            export namespace EventDispatcher {
                export class $__type<TOwner extends object, TCallback extends EventHandler> extends DependentObject {
                    ...
                    * This is handy in cases where an application state is persisted, and future handlers should always execute. */
                    ...
                    _getHandlerIndex(handler: TCallback | IDelegate<object, TCallback>): number {
                        if (handler instanceof Delegate.$__type) {
                    ...
                    */
                    ...
                    attach(handler: TCallback | IDelegate<object, TCallback>, eventMode: EventModes = EventModes.Capture): this {
                        if (this._getHandlerIndex(<any>handler) == -1) {
                            var delegate = handler instanceof Delegate.$__type ? <IDelegate<object, TCallback>>handler : Delegate.new(this, <TCallback>handler);
                    ...
                    private static [constructor](factory: typeof EventDispatcher) {
                        factory.init = <TOwner extends object, TCallback extends EventHandler>(o: $__type<TOwner, TCallback>, isnew: boolean, owner: TOwner, eventName: string, removeOnTrigger: boolean = false,
                        ...
                        factory.registerEvent = (type, eventName, eventMode?, removeOnTrigger?, eventTriggerCallback?, customEventPropName?, canCancel?) => {
                            ...
                            var onEventProxy = function (): IEventDispatcher<object, EventHandler> {
                                ...
                                var eventProperty: EventDispatcher.$__type<object, EventHandler> = instance[privateEventName];
            ...
            export interface IEventDispatcher<TOwner extends object, TCallback extends EventHandler> extends EventDispatcher.$__type<TOwner, TCallback> { }
        }
        ...
        export class EventObject extends FactoryBase(Object) {
            /**
        ...
        export namespace EventObject {
            export class $__type extends FactoryType(Object) implements INotifyPropertyChanged<IEventObject> {
                ...
                */
                ...
                private static [constructor](factory: typeof EventObject) {
        ...
        export interface IEventObject extends EventObject.$__type { }
