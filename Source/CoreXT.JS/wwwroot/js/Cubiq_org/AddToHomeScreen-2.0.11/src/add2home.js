...
var addToHome = (function (w) {
	...
	function init () {
		...
		if (options.hookOnLoad) {
		    if (window.DreamSpace) window.DreamSpace.System.onReady.addListener(loaded); // (support the DreamSpace framework)
		    else w.addEventListener('load', loaded, false); // (else hook into the window's 'load' event)
