...
(function (CoreXT) {
    ...
    (function (System) {
        ...
        var Events;
        (function (Events) {
            CoreXT.namespace(function () { return CoreXT.System.Events; });
            ;
            ;
            ...
            var EventDispatcher = /** @class */ (function (_super) {
                ...
                /** Creates an event object for a specific even type.
                    ...
                    */
                EventDispatcher['new'] = function (owner, eventName, removeOnTrigger, eventTriggerHandler, canCancel) {
                ...
                EventDispatcher.init = function (o, isnew, owner, eventName, removeOnTrigger, eventTriggerHandler, canCancel) {
                    if (removeOnTrigger === void 0) { removeOnTrigger = false; }
                    if (eventTriggerHandler === void 0) { eventTriggerHandler = null; }
                    if (canCancel === void 0) { canCancel = true; }
                };
            ...
            (function (EventDispatcher) {
                var $__type = /** @class */ (function (_super) {
                    ...
                    $__type.prototype.getEventName = function () { return this.__eventName; };
                    /** Returns true if handlers exist on this event object instance. */
                    $__type.prototype.hasHandlers = function () { return !!this.__listeners.length; };
                    $__type.prototype.dispose = function () {
                        // ... remove all handlers ...
                     ...
                     */
                    $__type.prototype.associate = function (obj) {
                    ...
                    $__type.prototype.disassociate = function (obj) {
                    ...
                    $__type.prototype.isAssociated = function (obj) {
                        return this.__associations.has(obj);
                    };
                    $__type.prototype._getHandlerIndex = function (handler) {
                        if (handler instanceof System.Delegate.$__type) {
                    ...
                    $__type.prototype.attach = function (handler, eventMode) {
                        if (eventMode === void 0) { eventMode = EventModes.Capture; }
                        if (this._getHandlerIndex(handler) == -1) {
                            var delegate = handler instanceof System.Delegate.$__type ? handler : System.Delegate.new(this, handler);
                    ...
                    /** Dispatch the underlying event. Typically 'dispatch()' is called instead of calling this directly. Returns 'true' if all events completed, and 'false' if any handler cancelled the event.
                      ...
                      */
                    $__type.prototype.dispatchEvent = function (triggerState) {
                        ...
                        if (parent) {
                            ...
                            while (parent) {
                                ...
                                if (eventInstance instanceof $__type)
                    ...
                    $__type.prototype.__exception = function (msg, error) {
                        if (error)
                    ...
                    $__type.prototype.onDispatchEvent = function (args, mode) {
                    ...
                    /** If the given state value is different from the last state value, the internal trigger state value will be updated, and true will be returned.
                        ...
                        */
                    $__type.prototype.setTriggerState = function (triggerState) {
                    ...
                    /** Resets the current internal trigger state to null. The next call to 'setTriggerState()' will always return true.
                        ...
                        */
                    $__type.prototype.resetTriggerState = function () { this.__lastTriggerState = null; };
                    /** If called within a handler, prevents the other handlers from being called. */
                    $__type.prototype.cancel = function () {
                    ...
                    $__type.prototype.__indexOf = function (object, handler) {
                    ...
                    $__type.prototype.__removeListener = function (i) {
                    ...
                    $__type.prototype.removeListener = function (handler, func) {
                    ...
                    $__type.prototype.removeAllListeners = function () {
                        for (var i = this.__listeners.length - 1; i >= 0; --i)
                    ...
                    $__type[CoreXT.constructor] = function (factory) {
                        ...
                        factory.registerEvent = function (type, eventName, eventMode, removeOnTrigger, eventTriggerCallback, customEventPropName, canCancel) {
        ...
        var EventObject = /** @class */ (function (_super) {
            ...
            */
            EventObject['new'] = function () { return null; };
            /**
            ...
            */
            EventObject.init = function (o, isnew) {
                this.super.init(o, isnew);
            };
            return EventObject;
        }(CoreXT.FactoryBase(System.Object)));
        System.EventObject = EventObject;
        (function (EventObject) {
            var $__type = /** @class */ (function (_super) {
                __extends($__type, _super);
                function $__type() {
                ...
                */
                $__type.prototype.doPropertyChanging = function (name, newValue) {
                ...
                $__type.prototype.doPropertyChanged = function (name, oldValue) {
            ...
            EventObject.$__type = $__type;
            EventObject.$__register(System);
        })(EventObject = System.EventObject || (System.EventObject = {}));
        // ====================================================================================================================
