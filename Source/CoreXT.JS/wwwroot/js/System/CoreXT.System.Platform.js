        ...
        (function (Platform) {
            ...
            var $Context = (function (_super) {
                ...
                $Context['$Context Factory'] = function () {
                    ...
                    var factoryType = (function (_super) {
                        ...
                        return Factory;
                    }(CoreXT.FactoryBase($Context, $Context['$Object Factory'])));
                    ...
                    return factoryType.register(Platform);
                }();
                return $Context;
            }(System.Object.$__type));
            Platform.Context = $Context['$Context Factory'].$__type;
            var $UIApplication = (function (_super) {
                ...
                $UIApplication['$UIApplication Factory'] = (function (_super) {
                    ...
                    return Factory;
                }(CoreXT.FactoryBase($UIApplication, $UIApplication['$Application Factory']))).register(Platform);
                return $UIApplication;
            }(System.Application.$__type));
            Platform.UIApplication = $UIApplication['$UIApplication Factory'].$__type;
