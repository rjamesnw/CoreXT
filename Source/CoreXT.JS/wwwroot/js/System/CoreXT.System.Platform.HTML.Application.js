        ...
        (function (Platform) {
            ...
            (function (HTML) {
                ...
                (function (Application) {
                    ...
                    var HTMLApplication = (function (_super) {
                        __extends(HTMLApplication, _super);
                        function HTMLApplication() {
                            return _super !== null && _super.apply(this, arguments) || this;
                        }
                        return HTMLApplication;
                    }(Platform.UIApplication.$__type));
                    Application.HTMLApplication = HTMLApplication;
                    var $ApplicationElement = (function (_super) {
                        ...
                        $ApplicationElement['$ApplicationElement Factory'] = (function (_super) {
                            ...
                            Factory.prototype.init = function ($this, isnew, title, description, targetElement) {
                                if (targetElement === void 0) { targetElement = null; }
                            ...
                            return Factory;
                        }(CoreXT.FactoryBase($ApplicationElement, $ApplicationElement['$HTML Factory']))).register(Application);
