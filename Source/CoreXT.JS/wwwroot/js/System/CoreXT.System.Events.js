    ...
    (function (System) {
        ...
        (function (Events) {
            ...
            var $EventDispatcher = (function (_super) {
                ...
                $EventDispatcher['$EventDispatcher Factory'] = function () {
                    return (function (_super) {
                        ...
                        Factory.prototype.init = function ($this, isnew, owner, eventName, removeOnTrigger, eventTriggerHandler, canCancel) {
                            if (removeOnTrigger === void 0) { removeOnTrigger = false; }
                            if (eventTriggerHandler === void 0) { eventTriggerHandler = null; }
                            if (canCancel === void 0) { canCancel = true; }
                            ...
                            $this.__eventPropertyName = Events.EventDispatcher.createEventPropertyNameFromEventName(eventName);
                            $this.owner = owner;
                        ...
                        return Factory;
                    }(CoreXT.FactoryBase($EventDispatcher, $EventDispatcher['$Object Factory']))).register(Events);
                }();
                return $EventDispatcher;
            }(System.DependencyObject));
            Events.EventDispatcher = $EventDispatcher['$EventDispatcher Factory'].$__type;
        ...
        var $EventObject = (function (_super) {
            ...
            $EventObject['$EventObject Factory'] = (function (_super) {
                __extends(Factory, _super);
                function Factory() {
                    return _super !== null && _super.apply(this, arguments) || this;
                }
                ...
                return Factory;
            }(CoreXT.FactoryBase($EventObject, $EventObject['$Object Factory']))).register(System);
            return $EventObject;
        }(System.Object.$__type));
        System.EventObject = $EventObject['$EventObject Factory'].$__type;
