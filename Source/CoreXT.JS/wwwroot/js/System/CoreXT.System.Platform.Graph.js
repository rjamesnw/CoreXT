        ...
        (function (Platform) {
            ...
            var $GraphNode = (function (_super) {
                ...
                $GraphNode.prototype.setValue = function (index, value, triggerChangeEvents) {
                    ...
                    if (property === void 0)
                        this.__properties[name] = property = new Platform.Property(this, null, value);
                    else
                ...
                $GraphNode['$GraphNode Factory'] = (function (_super) {
                    ...
                    Factory.prototype.init = function ($this, isnew, parent) {
                        if (parent === void 0) { parent = null; }
                        $this._id = $GraphNode.__nextID++;
                        var i, n, p, type = $this.constructor, sp = type.__staticProperties;
                        if (sp !== void 0)
                            while (sp) {
                    ...
                    return Factory;
                }(CoreXT.FactoryBase($GraphNode, $GraphNode['$PropertyEventBase Factory']))).register(Platform);
                return $GraphNode;
            }(Platform.PropertyEventBase.$__type));
            System.Object.defineProperty($GraphNode, 'uiElementMap', { writable: false, configurable: false });
            Platform.GraphNode = $GraphNode['$GraphNode Factory'].$__type;
