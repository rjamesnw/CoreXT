        ...
        (function (IO) {
            ...
            (function (Path) {
                ...
                var $Query = (function () {
                    ...
                    $Query['$Query Factory'] = (function (_super) {
                        ...
                        Factory.prototype.init = function ($this, isnew, searchString, makeNamesLowercase) {
                            if (searchString === void 0) { searchString = null; }
                            if (makeNamesLowercase === void 0) { makeNamesLowercase = false; }
                            if (searchString) {
                                ...
                                if (nameValuePairs)
                                    for (var i = 0, n = nameValuePairs.length; i < n; ++i) {
                                        ...
                                        if (makeNamesLowercase)
                                            $this.values[decodeURIComponent(nameValue).substring(1, eqIndex).toLowerCase()] = decodeURIComponent(nameValue.substring(eqIndex + 1));
                                        else
                                            $this.values[decodeURIComponent(nameValue).substring(1, eqIndex)] = decodeURIComponent(nameValue.substring(eqIndex + 1));
                                    }
                            }
                            return $this;
                        };
                        return Factory;
                    }(CoreXT.FactoryBase($Query, null))).register(Path);
                    return $Query;
                }());
                Path.Query = $Query['$Query Factory'].$__type;
