...
(function (CoreXT) {
    ...
    (function (System) {
        var $TimeSpan = (function (_super) {
            ...
            $TimeSpan['$TimeSpan Factory'] = (function (_super) {
                __extends(Factory, _super);
                function Factory() {
                    return _super !== null && _super.apply(this, arguments) || this;
                }
                Factory.prototype['new'] = function (year, dayOfYear, hours, minutes, seconds, milliseconds) { return null; };
                Factory.prototype.init = function ($this, isnew, year, dayOfYear, hours, minutes, seconds, milliseconds) {
                ...
                return Factory;
            }(CoreXT.FactoryBase($TimeSpan, $TimeSpan['$Object Factory']))).register(System);
            return $TimeSpan;
        }(System.Object.$__type));
        System.TimeSpan = $TimeSpan['$TimeSpan Factory'].$__type;
